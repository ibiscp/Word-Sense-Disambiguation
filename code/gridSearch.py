...
class gridSearch:
    ...
    def fit(self, X, y, X_test, y_test):
        ...
        for g in ParameterGrid(self.param_grid):
            ...
            model.fit_generator(self.generator(X, y, batch_size=g['batchSize'], output_size=self.output_size), steps_per_epoch=100, validation_data=(X_test, y_test), epochs=g['epochs'], callbacks=[cbk])
